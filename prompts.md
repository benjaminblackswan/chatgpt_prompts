Please give a 100 word paragraph explanation for the correct option(s) and a 60 word paragraph explanation for incorrect options.
...
Start with only one green tick or one red cross before the option statement, not in the explanation paragraph.
State the option statement in full.
in the same order the option is given in the question. 
Only use bold for option statement.
Add question requirements at the beginning in dot point format.
